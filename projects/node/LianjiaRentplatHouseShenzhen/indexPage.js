        ...
        districtNames.forEach(function(districtName){
            ...
            axios.get(`https://app.api.lianjia.com/Rentplat/v1/house/list?city_id=440300&condition=${districtName}/rt200600000001&limit=${limit}&offset=0&scene=list`).then(function(response){
                ...
                async.mapLimit(offsets,limit,async function(offset){
                    let response=await axios.get(`https://app.api.lianjia.com/Rentplat/v1/house/list?city_id=440300&condition=${districtName}/rt200600000001&limit=${limit}&offset=${offset}&scene=list`,{timeout:60000*2});
                    {
                        let data=response.data.data;
                        appendFile(data.list);
                    }
