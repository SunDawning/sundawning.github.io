# scripting - Is automatic "Reload from disk" confirmation in Text Editor possible? - Blender Stack Exchange: https://blender.stackexchange.com/questions/113912/is-automatic-reload-from-disk-confirmation-in-text-editor-possible
